        ...
        const data: TimelineEvent[] = [
          {
            ...
            date: '2022-01-15',
            description:
              'Leading a team of 5 engineers in developing a scalable microservices architecture. Implementing CI/CD pipelines and mentoring junior developers.',
            icon: 'work',
          ...
          },
          {
            ...
            date: '2021-11-05',
            description:
              'Obtained advanced certification in cloud architecture and deployment strategies.',
            icon: 'education',
          ...
          },
          {
            ...
            date: '2020-03-10',
            description:
              'Developed and maintained multiple client projects using React, Node.js, and PostgreSQL. Implemented responsive designs and optimized application performance.',
            icon: 'work',
          ...
          },
          {
            ...
            date: '2019-09-15',
            description:
              'Conducted a workshop on modern frontend development practices for a community of 50+ developers.',
            icon: 'event',
          ...
          },
          {
            ...
            date: '2018-06-01',
            description:
              'Built interactive user interfaces using modern JavaScript frameworks. Collaborated with designers to implement pixel-perfect designs.',
            icon: 'work',
        ...
        <div className="relative border-l-4 border-primary pl-6 ml-4 space-y-10">
          {filteredEvents.map((event, index) => (
            <div key={event.id} className="relative">
              {/* Timeline node */}
              <div className="absolute -left-9 flex items-center justify-center w-12 h-12 rounded-full bg-primary text-white shadow-md">
